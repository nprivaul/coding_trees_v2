    ...
    def train_and_eval(self, debug_mode=False):
        ...
        for epoch in range(self.epochs):
            ...
            for idx in self.coordinate:
                ...
                loss = loss + self.loss(self(tx_term.T, coordinate=idx), self.phi_fun(tx_term[1:, :], coordinate=idx))
#                print(loss)
#                print(self(tx_term.T, coordinate=idx))
#                print(self.phi_fun(tx_term[1:, :], coordinate=idx))
            ...
            if epoch % 1000 == 0 or epoch + 1 == self.epochs:
                if debug_mode:
                    ...
                    self.eval()
                    for idx in range(1): # self.coordinate:
                        nn = (
